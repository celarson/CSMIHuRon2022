...
zoop2022_3<-zoop2022_3 %>% select(-c(Density.Ascomorphaeucaudis,Density.Ascomorphaovalis))
zoop2022_3<-zoop2022_3 %>% select(-c(Density.Bosminalongirostris,Density.Bosminaspp))
zoop2022_3<-zoop2022_3 %>% select(-c(Density.Keratellacochlearis,Density.Keratellacrassa,Density.Keratellaearlinae,Density.Keratellahiemalis,Density.Keratellaquadrata))
zoop2022_3<-zoop2022_3 %>% select(-c(Density.Lecaneflexilis,Density.Lecaneludwigi,Density.Lecanespp,
